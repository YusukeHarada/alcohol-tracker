...
const NAV_ITEMS = [
  ...
  { href: '/templates', label: 'テンプレート', Icon: BoltIcon },
...
export function BottomNav() {
  ...
  return (
    <nav className="fixed bottom-3 left-3 right-3 max-w-md mx-auto bg-white/90 backdrop-blur-md rounded-2xl shadow-lg border border-slate-100 z-40">
      <div className="max-w-md mx-auto flex">
        {NAV_ITEMS.map(({ href, label, Icon }) => {
          ...
          return (
            ...
            >
              <span className={`p-1 rounded-xl transition-colors ${isActive ? 'bg-indigo-50' : ''}`}>
